    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-blue-50 rounded-xl p-8 mb-12">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Special Rural Healthcare Benefits</h2>
          <p className="text-lg text-gray-600">Enhanced Medicare benefits designed specifically for rural communities</p>
        </div>
